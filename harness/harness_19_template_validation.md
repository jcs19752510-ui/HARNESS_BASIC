...
## §4. 프로젝트 규모별 적용 프로파일 (2026-09-05 추가)

> 20종 문서를 전부 매번 채우는 건 1인 프로젝트엔 과하다는 게 실전에서
> 확인됨(attendance-app에서 CODEOWNERS를 실효성 없다고 보류한 사례). 문서
> 자체를 줄이는 대신, "이 규모면 이건 생략 가능"을 명시해 빈칸을 죄책감 없이
> 건너뛸 수 있게 한다.
